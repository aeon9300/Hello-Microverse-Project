...
const html_1 = require("@hint/utils/dist/src/dom/html");
const snapshot_1 = require("@hint/utils/dist/src/dom/snapshot");
...
const createHTMLFragment = (roots, resource) => {
    ...
    snapshot_1.restoreReferences(dom);
    return new html_1.HTMLDocument(dom, resource);
};
