...
const meta = {
    docs: {
        ...
        description: i18n_import_1.getMessage('parsing_description', 'en'),
        name: i18n_import_1.getMessage('parsing_name', 'en')
    },
    getDescription(language) {
        return i18n_import_1.getMessage('parsing_description', language);
    },
    getName(language) {
        return i18n_import_1.getMessage('parsing_name', language);
    },
    id: 'axe/parsing',
    schema: [{
