...
const axeCorePromise = read_file_async_1.readFileAsync(require.resolve('axe-core'));
...
exports.register = (context, rules, disabled) => {
    ...
    context.on('scan::end', async ({ resource }) => {
        ...
        for (const violation of result.violations) {
            for (const node of violation.nodes) {
                ...
                const severity = types_1.Severity[registration.options[violation.id]] || toSeverity(violation.impact);
