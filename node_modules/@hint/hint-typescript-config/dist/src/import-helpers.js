...
class TypeScriptConfigImportHelpers {
    constructor(context) {
        const validate = config_checker_1.configChecker('compilerOptions.importHelpers', true, 'importHelpers', context);
        const validateTslibInstalled = async (evt) => {
            ...
            try {
                ...
                debug(e);
                context.report(resource, i18n_import_1.getMessage('couldNotFindTSLib', context.language));
            }
        };
