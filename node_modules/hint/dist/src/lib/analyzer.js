...
const { cutString } = utils_1.misc;
const { cwd, isFile } = utils_1.fs;
...
class Analyzer {
    ...
    static getUserConfig(filePath) {
        ...
        const configPath = isDirectory ? config_1.Configuration.getFilenameForDirectory(filePath || cwd()) : filePath;
        if (!configPath) {
            return null;
        }
        try {
